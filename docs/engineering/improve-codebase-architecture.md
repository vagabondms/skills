...
```bash
npx skills add vagabondms/skills --skill=improve-codebase-architecture
```
...
[Source](https://github.com/vagabondms/skills/tree/main/skills/engineering/improve-codebase-architecture)
