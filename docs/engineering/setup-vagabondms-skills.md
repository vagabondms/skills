...
```bash
npx skills add vagabondms/skills --skill=setup-vagabondms-skills
```

```bash
npx skills update setup-vagabondms-skills
```

[Source](https://github.com/vagabondms/skills/tree/main/skills/engineering/setup-vagabondms-skills)

## What it does

`setup-vagabondms-skills` teaches one repo how the engineering skills should behave in it — where issues live, what the triage labels are called, and where the domain docs sit — and records those answers as **config** the other skills read.
...
You invoke this by typing `/setup-vagabondms-skills` — the agent won't reach for it on its own.
