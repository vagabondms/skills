...
```bash
npx skills add vagabondms/skills --skill=setup-minseok-skills
```

```bash
npx skills update setup-minseok-skills
```

[Source](https://github.com/vagabondms/skills/tree/main/skills/engineering/setup-minseok-skills)

## What it does

`setup-minseok-skills` teaches one repo how the engineering skills should behave in it — where issues live, what the triage labels are called, and where the domain docs sit — and records those answers as **config** the other skills read.
...
You invoke this by typing `/setup-minseok-skills` — the agent won't reach for it on its own.
