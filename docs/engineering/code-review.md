...
```bash
npx skills add vagabondms/skills --skill=code-review
```
...
[Source](https://github.com/vagabondms/skills/tree/main/skills/engineering/code-review)
