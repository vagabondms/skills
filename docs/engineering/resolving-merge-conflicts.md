...
```bash
npx skills add vagabondms/skills --skill=resolving-merge-conflicts
```
...
[Source](https://github.com/vagabondms/skills/tree/main/skills/engineering/resolving-merge-conflicts)
