...
```bash
npx skills add vagabondms/skills --skill=writing-great-skills
```
...
[Source](https://github.com/vagabondms/skills/tree/main/skills/productivity/writing-great-skills)
